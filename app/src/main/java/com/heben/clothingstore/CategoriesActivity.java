...
public class CategoriesActivity extends BaseActivity {
    ...
    private void addCategory() {
        ...
        if (name.isEmpty()) {
            MediaSoundHelper.getInstance().playError(CategoriesActivity.this);   // ← 音效
    ...
    private void deleteCategory(Category category) {
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                MediaSoundHelper.getInstance().playDelete(CategoriesActivity.this);   // ← 音效
    ...
    private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.btnDelete.setOnClickListener(view -> {
                MediaSoundHelper.getInstance().playConfirm(CategoriesActivity.this);   // ← 音效
                new AlertDialog.Builder(CategoriesActivity.this)
                        ...
                        .setNegativeButton("取消", (dialog, which) -> {
                            MediaSoundHelper.getInstance().playCancel(CategoriesActivity.this);   // ← 音效
                        })
                        .show();
            });
        }
